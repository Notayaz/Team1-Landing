...
const menuItems = [
	...
	{ title: "Code Translator", icon: <IoCodeSlashOutline />, gradientFrom: "#56CCF2", gradientTo: "#2F80ED" },
	{ title: "Virtual Lab", icon: <IoFlaskOutline />, gradientFrom: "#FF9966", gradientTo: "#FF5E62" },
	{ title: "Career Guidance", icon: <IoBriefcaseOutline />, gradientFrom: "#80FF72", gradientTo: "#7EE8FA" },
];
		...
		<div className="flex items-center justify-center min-h-[4rem]">
			<ul className="flex gap-4">
				{menuItems.map(({ title, icon, gradientFrom, gradientTo }, idx) => (
					...
					>
						<a href="#" className="absolute inset-0 rounded-full outline-none focus:ring-2 focus:ring-primary/60">
